...
# Création des fichiers de liste de contenu pour EvenFolder et OddFolder
Get-ChildItem -Path C:\EvenFolder | Out-File -FilePath C:\ListeEven.txt
Get-ChildItem -Path C:\OddFolder | Out-File -FilePath C:\ListeOdd.txt